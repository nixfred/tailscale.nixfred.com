...
> Bootstrapped 2026-08-10 by the NixFred Site Factory.
...
1. Public repo github.com/nixfred/tailscale.nixfred.com, Pages project
   tailscale-nixfred-com, domain tailscale.nixfred.com, deploy is ./deploy.sh
